...
<div class="demo-bar">🧪 Web de demostración · negocio ficticio · <a href="../">¿Quieres una así para tu negocio? 99€ en 48 h →</a></div>
...
<footer><div class="wrap">{name} · Oviedo, Asturias · Web de demostración creada por <a href="../">Web48h</a></div></footer>
